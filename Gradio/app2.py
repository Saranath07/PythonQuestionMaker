...
# Load JSON data
file_path = "json_files/template_1.json"
...
def create_first_page():
    with gr.Column() as page1:
        ...
        next_button.click(fn=None, inputs=None, outputs=page1, _js="() => { return '' }")  # Hide first page
    return page1
...
def create_second_page():
    with gr.Column(visible=False) as page2:
        ...
        next_button = gr.Button("Next")
        next_button.click(fn=None, inputs=None, outputs=page2, _js="() => { return '' }")  # Hide second page
    return page2
...
if __name__ == "__main__":
    with gr.Blocks() as app:
        page1 = create_first_page()
        page2 = create_second_page()
        page3 = create_third_page()

        # Add logic to switch between pages
        page1.children[-1].click(fn=None, inputs=None, outputs=page2, _js="() => { document.querySelectorAll('.gr-blocks')[0].style.display = 'none'; document.querySelectorAll('.gr-blocks')[1].style.display = 'block'; }")
        page2.children[-1].click(fn=None, inputs=None, outputs=page3, _js="() => { document.querySelectorAll('.gr-blocks')[1].style.display = 'none'; document.querySelectorAll('.gr-blocks')[2].style.display = 'block'; }")
